...
\noindent Other options which are present in \ili{Bulgarian}, namely \textsc{htld}, \textsc{cllc}, are lacking in \ili{Torlak}. In fact, the equivalent \ili{Torlak} examples of \REF{ex:zivojinovic:8} and \REF{ex:zivojinovic:9}, illustrated in \citet{Cinque.Krapova2008}, are ungrammatical.
