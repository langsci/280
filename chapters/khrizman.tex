...
%\z\z
\begin{exe}
\ex\label{ex:khrizmann:12} Measure phrase\vspace{-10pt}
    \begin{multicols}{2}
        \begin{xlist}
...
\begin{exe}
\ex\label{ex:khrizmann:13} Adjective\vspace{-10pt}
    \begin{multicols}{2}
        \begin{xlist}
...
\ea\label{ex:khrizmann:16} a 100-gram apple
...
\noindent Count nouns have the same ambiguity in \ili{Russian}, too \REF{ex:khrizmann:28} (see \citealt{Partee.Borschev2012,Khrizman.Rothstein2015,Khrizman2016a,Khrizman2016b}).
...
\ea\label{ex:khrizmann:33} \textit{Context:} `They served wonderful pickled mushrooms at Masha's wedding!'\\
...
\ea\label{ex:khrizmann:36} \gll Eén patat met, één zonder, en één met satésaus, alstublieft.\\
...
\noindent Shifts from count nouns to measures have been well studied. They are productive semantic operations which occur in many languages including Hebrew \citep{Rothstein2009}, Mandarin \citep{Li2013}, \ili{Hungarian} \citep{Schvarcz2014}, and \ili{Russian} \citep{Partee.Borschev2012,Khrizman2016a,Khrizman2016b}. In some of these languages there are dedicated morpho-syntactic means to express such shifts, e.g. the \textit{-nyi} suffix in \ili{Hungarian} \citep{Schvarcz2014,Schvarcz2017}.
